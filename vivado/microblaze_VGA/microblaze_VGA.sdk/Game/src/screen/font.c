...
void write_1(uint8_t x, uint8_t y, uint16_t color) {
	vga_draw(x, y+1, color);
...
void write_2(uint8_t x, uint8_t y, uint16_t color) {
	vga_draw(x, y, color);
...
void write_3(uint8_t x, uint8_t y, uint16_t color) {
	vga_draw(x, y, color);
...
void write_4(uint8_t x, uint8_t y, uint16_t color) {
	vga_draw(x, y, color);
	vga_draw(x, y+1, color);
	vga_draw(x, y+2, color);
...
void write_5(uint8_t x, uint8_t y, uint16_t color) {
	vga_draw(x, y, color);
	vga_draw(x, y+1, color);
	vga_draw(x, y+3, color);
...
void write_6(uint8_t x, uint8_t y, uint16_t color) {
	vga_draw(x, y+1, color);
	vga_draw(x, y+2, color);
	vga_draw(x, y+3, color);
...
void write_7(uint8_t x, uint8_t y, uint16_t color) {
	vga_draw(x, y, color);
...
void write_8(uint8_t x, uint8_t y, uint16_t color) {
	vga_draw(x, y+1, color);
	vga_draw(x, y+2, color);
	vga_draw(x, y+3, color);
...
void write_9(uint8_t x, uint8_t y, uint16_t color) {
	vga_draw(x, y+1, color);
...
void write_0(uint8_t x, uint8_t y, uint16_t color) {
	vga_draw(x, y+1, color);
	vga_draw(x, y+2, color);
	vga_draw(x, y+3, color);
...
number_writer_t number_writers[] = {
		{'1', write_1},
		{'2', write_2},
		{'3', write_3},
		{'4', write_4},
...
void write_digit(char number, uint8_t x, uint8_t y, uint16_t color) {

	for(uint8_t i=0; i<DIGITS_NUMBER; i++) {
		if(number == number_writers[i].c) {
			number_writers[i].write(x, y, color);
		}
	}
}
...
void font_write_digits(const char *str, const uint8_t x_pos, const uint8_t y_pos,
		uint16_t color){
	uint8_t x = x_pos;

	for(char *c = str; (*c) != NULL; c++) {

		write_digit(*c, x, y_pos, color);
		x += DIGIT_WIDTH;
	}
}
